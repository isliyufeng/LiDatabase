        ...
        <div class="container">
            <span>欢迎来到Y先生教育！</span>
	            ...
	            <div id="regBlock" style="display:none;float:right">
	               <a href="${pageContext.request.contextPath}/user/showMyProfile" id="reg_open"><img src="${pageContext.request.contextPath}/img/we.png">注册</a>
	               <a href="${pageContext.request.contextPath}/user/showMyProfile" id="login_open"><img src="${pageContext.request.contextPath}/img/we.png">登录</a>
	            </div>
