...
<head>
    ...
    <script type="text/javascript">
        ...
        // 添加或修改
        function commitForm() {
            $.post("${pageContext.request.contextPath}/video/saveOrUpdate",
    ...
    <form class="form-horizontal" id="formSaveAndUpdate">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                ...
                <div id="photo"></div>
                <input type="hidden" id="imageUrl" name="imageUrl" class="form-control" value="${video.imageUrl}"
                       placeholder="具体的url">
            </div>
        </div>
